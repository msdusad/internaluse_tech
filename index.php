      ...
      <div class="nav_menu">
        <nav>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class=""> <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <img src="images/img.jpg" alt="">John Doe <span class=" fa icon-angle-down"></span> </a>
              <ul class="dropdown-menu dropdown-usermenu pull-right">
                ...
                <li><a href="Login/index.php"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
              </ul>
            </li>
