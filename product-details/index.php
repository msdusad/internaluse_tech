    ...
    <div class="right_col" role="main">
      <div class="row">
        <div class="col-sm-7 col-md-8 col-lg-9 margin-top-10">
          <div class="x_panel tile">
            ...
            <div class="x_content" id="imageSelecter">
                 <div class="panel-info bg-info panel-body margin-bottom-20">
				     Hi
				 </div>
				...
				<div class="tab-content margin-top-20">
				  ...
				  <div class="tab-pane" id="tab2">
					  <p>
					     There are no Relationships available. <a href="addnew" class="green">Add new</a>
					  </p>
				  </div>
				  <div class="tab-pane" id="tab3">
					  <p>
					    There are no Asset available.
					  </p>
				  </div>
				</div>
            </div>
        ...
        <div class="col-sm-5 col-md-4 col-lg-3 col-xs-12 margin-top-10">
          <div class="x_panel tile">
            <div class="x_title">
			  <a href="#" class="btn btn-success noBorderRadius" data-toggle="modal" data-target="#attach">Attach</a>
			  <a href="#" class="btn btn-dark noBorderRadius">Edit</a>
			  <a href="#" class="btn btn-danger noBorderRadius">Delete</a>
              <div class="clearfix"></div>
            </div>
            <div class="x_content">
			 <p><a href="#" data-toggle="tooltip" data-placement="top" title="Product">Apple MacBook Air 13</a></p> 
              <form action="#" class="checkList">
                ...
                <p class="text-right"><button type="button" class="btn btn-dark noBorderRadius">Update<i class="icon-angle-double-right"></i></button></p>
              </form>
            </div>
          </div>
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <div class="row">
		    <div class="col-sm-6">
			     <p class="h4">Relationship</p>
				 <ul class="list-right">
				    <li><a href="#">Depends On</a></li>
					<li><a href="#">Uses</a></li>
				 </ul>
			</div>
			<div class="col-sm-6">
			     <p class="h4">Inverse Relationship</p>
				 <ul class="list-right">
				    <li><a href="#">Depends On</a></li>
					<li><a href="#">Uses</a></li>
				 </ul>
...
<div class="modal fade" id="primary" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
