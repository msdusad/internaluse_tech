		    ...
		    <div class="row">
			   <div class="col-xs-12 padding-top-10">
				  <div class="x_panel tile">
					<div class="x_title">
					 <div class="row">
					    <div class="col-lg-7 padding-top-10">
						  <a href="index.php" class="h4"><i class="icon-left-small"></i>Back to Problem</a>
						</div>
					...
					<div class="x_content">
						<h1 class="h3 padding-bottom-10">Create a New Problem</h1>
  ...
  <div class="modal fade" id="imageSelecter" role="dialog">
	...
	<div class="tab-content padding-top-10">
	    <div class="tab-pane active" id="upload">
	        <form action="#" class="checkList padding-top-10">
				<div class="fileUpload btn btn-danger btn-round">
					<span><i class="icon-download"></i> Upload</span>
			 ...
			 <div class="table-responsive margin-top-20">
                        <table class="table table-striped jambo_table bulk_action">
							...
							<tbody>
								<tr class="checkList">
									<td>
									  <input type="checkbox" id="testNew" />
								      <label for="testNew">&nbsp;</label>
									</td>
