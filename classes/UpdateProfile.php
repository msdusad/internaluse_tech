...
//$this->profilepic = mysql_real_escape_string($_POST['profilepic']) ? $_POST['profilepic'] : null;
...
$update_profile_query="update user_detail a,users b set a.name='$this->full_name',a.mobile_number='$this->mobile_number',a.user_language='$this->user_language',a.location='$this->location',a.reporting_manager='$this->reporting_manager',a.updated_at=now(),b.email='$this->email' where a.user_id='$this->user' && b.id='$this->user'";
