...
$passwordcheck="select * from users where username='$this->_user' && password='$this->_oldpass'";
...
$update_password_query="update users set password='$this->_newpass' where username='$this->_user' && password='$this->_oldpass'";
