    ...
    ?>
              ...
              <div class="accordion-down">
                <div class="accordion padding-top-30" id="accordion" role="tablist" >
                  ...
                  <div class="panel"> <a class="panel-heading" role="tab" id="headingThree" data-toggle="collapse" href="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
                    <h4 class="panel-title">EBSProperties</h4>
                    </a>
                    <div id="collapseThree" class="panel-collapse collapse in padding-top-10 padding-bottom-20" role="tabpanel" aria-labelledby="headingThree">
                      <div class="row padding-top-10">
                        <div class="col-sm-6 col-xs-6 padding-bottom-10">
