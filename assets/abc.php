...
<div class="container body">
  <div class="main_container">
    ...
    ?>
              ...
              <div class="accordion-down">
                <div class="accordion padding-top-30" id="accordion" role="tablist" >
                  <div class="panel"> <a class="panel-heading" role="tab" id="headingOne" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse in padding-top-10" role="tabpanel" aria-labelledby="headingOne">
                      <div class="row">
              ...
              <p class="left_col padding-13 text-white margin-top-20">Assignment</p>
              <div class="row">
                <div class="col-sm-6 col-xs-12 padding-bottom-10">
